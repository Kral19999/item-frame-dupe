...
public class Config {
    ...
    private static final List<String> DEFAULT_DUPE_ITEMS = List.of(
    ...
    public static class ConfigValues {
        ...
        public boolean invPick = true;

        public List<String> dupeItems = new ArrayList<>(DEFAULT_DUPE_ITEMS);
    }
    ...
    public static boolean isItemAllowed(Item item) {
        boolean inList = getDupeItems().contains(item);
        return INSTANCE.blacklistMode ? !inList : inList;
    }

    public static void clearDupeItems() {
        INSTANCE.dupeItems.clear();
        cachedDupeItems = null;
        save();
    }

    public static void resetDupeItems() {
        INSTANCE.dupeItems = new ArrayList<>(DEFAULT_DUPE_ITEMS);
        cachedDupeItems = null;
        save();
    }
